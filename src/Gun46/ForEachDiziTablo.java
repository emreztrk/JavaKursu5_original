...
public class ForEachDiziTablo {
    public static void main(String[] args) {
        ...
        for (int eleman: dizi1) { // içindeki elemanları teker teker alarak eleman isimli değişkene atar
        ...
        System.out.println("tablo3.length = " + tablo3[0].length);  //0. satırın length 5
        System.out.println("tablo3.length = " + tablo3[1].length);  //1. saıtın length 2
        ...
        for (int[] satir : tablo3){
            ...
            //1. adımda satır 2 3 4 5 6 aşağıdaki döngü sadece 2,3 yazar
